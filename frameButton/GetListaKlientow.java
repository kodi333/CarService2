...
public class GetListaKlientow {
	
	public GetListaKlientow(){
		...
		String sql;
	    sql = "SELECT [ClientID] as 'ID Klienta', [Name] as 'Imie', [LastName] as 'Nazwisko', [ClientAddress] as 'Adres' FROM [krudzki_b].[dbo].[Clients]";
	    try {
		    ...
		    JDialog dialog = paneMessage.createDialog("Lista Klientow");
