...
public class DeleteClientNameFrame {
	...
	{
		new DeleteClientNameFrame();
	}
	
	
	public DeleteClientNameFrame() {
		
		String[] labels = {"ID Klienta: "};
		...
		JButton Submit = new JButtonConnect("Usun","DeleteClient");
		// exit frame on click
