...
public class GetListaUslug {
	
	@SuppressWarnings({ "unchecked", "unused" })
	public GetListaUslug(){
		...
		String sql;
	    sql = "SELECT [ServiceId], [ServicesName] as 'Nazwa Uslugi',[Cost] as 'Koszt',[Currency] as 'Waluta' FROM [krudzki_b].[dbo].[Services]";
	    try {
