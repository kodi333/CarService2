...
public class GetListaPracownikow {
	
	public GetListaPracownikow(){
		...
		String sql;
	    sql = "SELECT [EmployeeID] as 'ID Pracownika',[EmployeeName] as 'Imie',[EmployeeLastName] as 'Nazwisko'," + 
	    "[EmployeePesel] as 'Pesel', [StartDate] as 'Data rozpoczecia'," +
        "[Position] as 'Stanowisko'," +
	    "[HomeAddress] as 'Adres zamieszkania' " +
        "FROM [krudzki_b].[dbo].[EmployeeHR]";
	    try {
		    ...
		    JDialog dialog = paneMessage.createDialog("Lista Pracownikow");
		    dialog.setBounds(100, 100, 1000, 400);
