...
public class DeleteClientCarFrame {
	...
	{
		new DeleteClientCarFrame();
	}
	
	
	public DeleteClientCarFrame() {
		
		String[] labels = {"ID Pojazdu: "};
		...
		JButton Submit = new JButtonConnect("Usun","DeleteClientCar");
		// exit frame on click
